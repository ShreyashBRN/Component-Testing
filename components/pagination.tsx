...
export default function Pagination({
  ...
  return h(
    "div",
    { className: cn("mx-auto flex w-full max-w-[860px] flex-col gap-12", className) },
    ...variants.map((v, i) =>
      h(
        "div",
        { key: v, className: "flex w-full flex-col items-center gap-2" },
        ...
        h(
          "p",
          {
            className: "text-center text-[18px] font-medium text-neutral-500 dark:text-neutral-400 capitalize",
          },
          `${i + 1}. ${v}`
        )
      )

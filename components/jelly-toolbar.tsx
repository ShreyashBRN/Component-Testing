          ...
          return (
            <React.Fragment key={item.label}>
              <button
                ...
                className="relative z-10 flex flex-1 items-center cursor-pointer justify-center rounded-full outline-none focus-visible:ring-2 focus-visible:ring-[#0d7d86] focus-visible:ring-offset-2 dark:focus-visible:ring-offset-neutral-900"
              >
                <Icon
                  size={18}
                  strokeWidth={2}
